...
export const useImportProxy = () => {
  ...
  return {
    ...
    // function importPositionWithSignature(IPool pool, address user, uint256 wethAmount, uint256 debtAmount, bytes memory controllerSig)

    // function importVaultWithSignature(IPool pool, address user, bytes memory controllerSig)
